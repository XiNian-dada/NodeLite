//! Shared defaults keep parsed and generated configuration consistent.

use std::path::PathBuf;

use super::{
    DEFAULT_AGENT_AUTH_TIMEOUT_SECS, DEFAULT_AGENT_INBOUND_TIMEOUT_SECS,
    DEFAULT_AGENT_SEND_TIMEOUT_SECS, DEFAULT_ALERT_INSPECTION_CPU_WARN_PERCENT,
    ...
    DEFAULT_CONNECT_TIMEOUT_SECS, DEFAULT_GEOIP_UPDATE_INTERVAL_DAYS, DEFAULT_HELLO_TIMEOUT_SECS,
    ...
    DEFAULT_SQLITE_BUSY_TIMEOUT_SECS, DEFAULT_STALE_AFTER_SECS,
...
pub(super) fn default_history_query_concurrency() -> usize {
    DEFAULT_HISTORY_QUERY_CONCURRENCY
}

pub(super) fn default_history_read_cache_kib() -> u64 {
...
pub(super) fn default_token_verify_max_parallelism() -> usize {
...
pub(super) fn default_agent_auth_timeout_secs() -> u64 {
    DEFAULT_AGENT_AUTH_TIMEOUT_SECS
}

pub(super) fn default_agent_send_timeout_secs() -> u64 {
    DEFAULT_AGENT_SEND_TIMEOUT_SECS
}

pub(super) fn default_agent_inbound_timeout_secs() -> u64 {
    DEFAULT_AGENT_INBOUND_TIMEOUT_SECS
}
