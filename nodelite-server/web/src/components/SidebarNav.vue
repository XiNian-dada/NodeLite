...
<template>
  <aside class="sidebar" aria-label="primary" data-test="sidebar-nav">
    ...
    <RouterLink
      ...
      to="/"
      :title="$t('index.nav.overview')"
      :aria-label="$t('index.nav.overview')"
    ...
    <RouterLink
      ...
      to="/logs"
      :title="$t('index.nav.logs')"
      :aria-label="$t('index.nav.logs')"
      data-test="nav-logs"
    >
      <svg
        viewBox="0 0 24 24"
